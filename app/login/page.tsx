          ...
          <div className="flex flex-col gap-2.5 mb-6">
            ...
            >
              <svg width="16" height="16" viewBox="0 0 16 16" aria-hidden="true">
                ...
                <path fill="#EA4335" d="M8 3.18c1.17 0 2.23.4 3.06 1.2l2.3-2.3A7.94 7.94 0 0 0 8 0 8 8 0 0 0 .86 4.4l2.66 2.07C4.15 4.59 5.92 3.18 8 3.18z" />
              </svg>
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                ...
                <Link
                  ...
                  className="text-xs text-[#e08a68] hover:underline"
                >
                  Forgot password?
                </Link>
              </div>
